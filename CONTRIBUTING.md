...
Hermes How To is a visual, example-driven guide to Hermes Agent. We provide:
...
Add examples for existing features (delegation, memory, skills, etc.):
...
### 3. Feature Guides
Create guides for new Hermes Agent features:
...
- Add relevant Hermes Agent version and OS
...
### 1. Fork and Clone
```bash
git clone https://github.com/your-username/hermes-howto.git
cd hermes-howto
```
...
Pre-commit hooks run the same checks as CI locally before every commit. All checks must pass before a PR will be accepted.
...
```
├── 01-quickstart/          # Getting started with Hermes
...
├── 06-voice/               # Voice interaction features
├── 07-messaging-gateway/   # Messaging integration
├── 08-cron/                # Scheduled tasks
├── 09-soul-personality/    # Agent personality customization
├── 10-toolsets/            # Tool collections
├── 11-plugins/             # Plugin system
├── 12-checkpoints/         # Session snapshots
├── 13-providers/           # LLM provider configuration
├── 14-context-refs/        # Context reference management
...
### Adding a Delegation Pattern
1. Create a `.md` file in `04-delegation/`
2. Include:
   ...
   - Usage examples
   - Customization tips
3. Update `04-delegation/README.md`
...
### Adding a Provider
1. Create a `.md` file in `13-providers/`
2. Include:
   - Provider capabilities
   - Configuration options
   - Environment setup
   - Usage examples
3. Update `13-providers/README.md`
...
docs(skills): Add comprehensive agent setup skill
```
